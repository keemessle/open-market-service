...
const $productShoppingMethod = document.getElementById(
  "product-shopping-method"
);
...
function createMeta(product) {
  ...
  $title.innerText = `${product.name} | 호두샵`;

  $head.innerHTML += `
    <meta
        name="description"
        content="${product.name}! 호두샵에서 바로 만나보세요!"
    />
    <meta name="author" content="호두샵" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="${product.name} | 호두샵" />
    <meta
